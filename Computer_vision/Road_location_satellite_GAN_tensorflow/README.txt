 ...
 However after 30 minutes training with a GPU the model was only generating black squares. Maybe it needs to be trained for a longer period and possibly there is a mismatch between inputs and targets. 
